...
def u_temp(cube_array, input_value):
...
def r_temp(cube_array, input_value):
...
def l_temp(cube_array, input_value):
    temp1 = cube_array[0][0]
...
def b_temp(cube_array, input_value):
...
def solution(cube_array, input_value):
    if input_value == 'U':
        temp1, temp2, temp3 = u_temp(cube_array, input_value)
        ...
        temp1, temp2, temp3 = r_temp(cube_array, input_value)
        ...
        temp1, temp2, temp3 = l_temp(cube_array, input_value)
        ...
        temp1, temp2, temp3 = b_temp(cube_array, input_value)
        cube_array[0][0], cube_array[1][0], cube_array[2][0] = temp3, temp1, temp2
